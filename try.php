...
<html lang="en">
  ...
  <script> 
     ...
     {
        var phead = $('.popup-head');
        phead.click(function(){
          alert("what the fucking heck is here ");
        })
     })
   </script>
   ...
   <script>
            ...
            function register_popup(id, name)
            {
                ...
                // "<div class='msg_body'><div class='msg_a'>mals</div><div class='msg_b'>come</div><div class='ins'></div></div><div class='mft'><textarea id='f' row='4' class='min'>w</textarea></div>"
                // +'</div></div>';
                ...
                element = element + '<div class="popup-head-right"><a href="javascript:close_popup(\''+ id +'\');">&#10005;</a></div>';
                element = element + '<div style="clear: both"></div></div><div class="popup-messages">'+
                "<div class='msg_body'><div class='msg_a'>mals</div><div class='msg_b'>come</div><div class='ins'></div></div><div class='mft'><input type='text' row='4' class='min'>w</input></div>"
                +'</div></div>';
...
<br/>
  ...
  <div class="pageContent">
   ...
   <div class="pull-right" id="rightPane1">
       ...
       <div id="onlinePals" class="pull-right">
         ...
         <!--now coding the online div elements -->
            ...
            <div class="sidebar-name">
                ...
                <a class='ulink' href="javascript:register_popup('codefig', 'abayomi Moshood');">
                    <img class="img-circle" src="social_img/haxor.jpg" height="40px" width="40px" 
                    />
           <span class="fa fa-globe onlineLogo"></span>
                <span>abayomi moshood</span>
                </a>
       ...
       <div class="sidebar-name">
                <!-- Pass username and display name to register popup -->
                <a class='ulink' href="javascript:register_popup('adeola', 'taiwo');">
                    <img class="img-circle" src="social_img/haxor.jpg" height="40px" width="40px" 
                    />
           <span class="fa fa-globe onlineLogo"></span>
                <span>Adeola Taiwo</span>
                </a>
            </div> <!--end of the sidebar element -->
            ...
            <div class="sidebar-name">
                <!-- Pass username and display name to register popup -->
                <a class='ulink' href="javascript:register_popup('salam', 'adebutu');">
                    <img class="img-circle" src="social_img/haxor.jpg" height="40px" width="40px" 
                    />
           <span class="fa fa-globe onlineLogo"></span>
                <span>Salami Adebutu</span>
                </a>
            </div> <!--end of the sidebar element -->
