       ...
       <div id="postBoard" class="pull-left">
          ...
          <div id="normalpane" class="pull-left">
            ...
            <div class="media">
              ...
              <div id="userDetails" style="color:#fff" uid="<?=$logged_userid?>" uname="<?=$fullname?>">w</div>
...
<!--  -->
   ...
   <script src="http://127.0.0.1:2000/socket.io/socket.io.js"></script>

        <script>
       var io = io.connect("http://127.0.0.1:2000");

       var userid = $('#userDetails').attr('uid');
       var uname = $('#userDetails').attr('uname');
      
        var udata = {id: userid , name : uname};
     

      //div for the online users 
  
       var onlinecontainer = $('.onlineUser');

    
         io.emit('online', udata);


        // io.on('add-user', function(userdata){
        //   setTimeout(function(){
        //      alert(userdata.uname);
        //   }, 4000);
     
       onlinecontainer.append('
